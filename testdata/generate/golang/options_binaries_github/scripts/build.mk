...
CI_PROJECT_PATH := github.com/kilianpaquier/craft
...
.PHONY: buildall
buildall: build-cli-name build-cron-name build-job-name build-worker-name

.PHONY: cli-name cron-name job-name worker-name
build-%:
