...
import (
	...
	"github.com/kilianpaquier/craft/pkg/api/test_tag"
)
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Craft {
	...
	cli.TestTag = test_tag.New(transport, formats)
	return cli
}
...
type Craft struct {
	...
	TestTag test_tag.ClientService
...
func (c *Craft) SetTransport(transport runtime.ClientTransport) {
	...
	c.TestTag.SetTransport(transport)
}
