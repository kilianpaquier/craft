...
type ClientService interface {
	UnsecuredPing(params *UnsecuredPingParams, opts ...ClientOption) (*UnsecuredPingOK, error)
...
func (a *Client) UnsecuredPing(params *UnsecuredPingParams, opts ...ClientOption) (*UnsecuredPingOK, error) {
	...
	if params == nil {
		params = NewUnsecuredPingParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "unsecuredPing",
		Method:             "GET",
		PathPattern:        "/unsecured/ping",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &UnsecuredPingReader{formats: a.formats},
	...
	success, ok := result.(*UnsecuredPingOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*UnsecuredPingDefault)
